...
The software is provided without warranties to the maximum extent permitted by law. The developer is not responsible for losses caused by misuse, incompatible systems, interrupted services, or actions taken by third-party platforms.

The source code remains private. No right to copy, modify, reverse engineer, redistribute, or resell the software is granted except where applicable law expressly requires otherwise or written permission is provided.
